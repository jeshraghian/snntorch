    ...
    if check_integrity(fpath, md5):
        ...
        try:
            if 'dropbox' in url:
                ...
                progress_bar = tqdm(total=total_size_in_bytes, unit='iB', unit_scale=True) # new
                # old
                ...
                if total_size_in_bytes != 0 and progress_bar.n != total_size_in_bytes:
                    print("Warning: Downloaded size {progress_bar.n} does not match {total_size_in_bytes}.")
