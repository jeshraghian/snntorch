...
in your work, please consider citing the following sources:
   ...
   arXiv:2210.03515, October 2022. <https://arxiv.org/abs/2210.03515>`__
...
Next, install the latest PyPi distribution of snnTorch and Tonic by
clicking into the following cell and pressing ``Shift+Enter``.
