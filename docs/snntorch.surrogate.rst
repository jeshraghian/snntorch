...
:mod:`snntorch` overrides the default gradient by using :mod:`snntorch.surrogate.html#snntorch.surrogate.ATan`.
...
If ``spike_grad`` is left unspecified, it defaults to :mod:`snntorch.surrogate.html#snntorch.surrogate.ATan`.
